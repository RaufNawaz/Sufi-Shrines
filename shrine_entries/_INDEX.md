# Shrine Entries — Index

37 shrine "Description" entries for the shrines project, in this folder. Each file has the sheet-ready
Description block (## Overview … ## Legacy/Bibliography) above a "REFERENCE ONLY" divider that holds
column suggestions, sourcing notes, and things to verify. Poetry is quoted in the original script with an
English translation where the saint was a poet.
...
These sheet rows are local or little-documented; the compendium + general knowledge were not enough to
write accurately, and I did not want to invent biographies for a public site. Each needs a dedicated source:

- Allo Mahar (Pir Syed Muhammad Channan Shah Nuri) — Sialkot
- Darbar Sakhi Shah Chan Charagh — Rawalpindi
- Dargah Fateh Pur Sharif (Syed Rakhyal Shah Sufi Al Qadri) — Balochistan
- Eidgah Sharif (Pir Abdul-ul-karim) — Sanghar (Duthro Sharif), Sindh
- Jamshoro District — Laki Shah Saddar (Syed Shah Sadaruddin Lakyari) — Sindh
- Langer Makhdoom (Makhdoom Burhan-ud-din) — Chiniot
- Purana Bhalwal (Shah Sulaiman Nuri) — Bhalwal
- Shah Yousuf — Shahpur
- Shamsabad (Shams Ali Qalandar) — Okara
- Wadpagga Sharif (Ghazi Syed Shah Fateh Muhammad Bukhari) — Peshawar
- Imam Ali-ul-Haq — Sialkot
  (Also out of scope for this Muslim-saints compendium: the sheet's Gurdwaras, temples, and other non-Muslim rows.)

## Notes

- Tier 2 entries are shorter and less deeply sourced than Tier 1; each carries verify-flags in its
  REFERENCE section (dates, lineages, transliterations). Have a specialist confirm before publishing.
- Verse in Sindhi/Seraiki/Pashto was quoted sparingly (orthography risk) or given in translation only,
  with flags to add clean originals.
