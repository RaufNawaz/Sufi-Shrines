...
ENG = json.load(open(os.path.join(OUT, "_english_descriptions.json"), encoding="utf-8"))

# tour-featured shrines get priority
tour_slugs = set()
try:
    tours = json.load(open(os.path.normpath(os.path.join(OUT, "..", "src", "data", "tours.json")), encoding="utf-8"))
    for t in tours:
...
open(os.path.join(OUT, "TRANSLATION_LOG.md"), "w", encoding="utf-8").write("\n".join(L))
