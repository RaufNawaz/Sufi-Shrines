...
QA_NOTES = {
    ...
    "shrine-of-mauj-darya-bukhari": (
        ...
        "survey's generosity and state of ecstasy. The survey also supplied ten photographs, "
        "mapped in data/new-photos-manifest.json and not yet fetched into public/photos/ — this "
        "row still publishes a single Wikimedia image."
    ),
}
