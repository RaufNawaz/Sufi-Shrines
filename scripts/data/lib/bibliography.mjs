/**
 * MIRROR of src/lib/data/bibliography.ts, for the build scripts.
 *
 * Kept in sync by src/lib/data/__tests__/bibliographySync.test.ts, which runs
 * both over every shipped row and requires identical output — the same
 * arrangement `scripts/data/lib/places.mjs` has. The scripts are plain ESM and
 * cannot import a `.ts`; two copies with a drift guard is the cheapest honest
 * answer to that, and the guard is what makes it honest.
 *
 * Below is the TypeScript file's own commentary, because the *reasoning* is the
 ...
 * the Description.
 */
export function bibliographyRegion(sourcesColumn, description) {
 ...
 */
export function bibliographyItems(sourcesColumn, description) {
