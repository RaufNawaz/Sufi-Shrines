...
export const UI_TEXT_UR: UiStrings = {
  ...
  descentHeading: 'سلسلے میں نسبت',
  descentNote:
    'ریکارڈ کے مطابق یہ نسبت سلسلے میں کئی واسطوں سے ہے — نہ براہِ راست جانشینی، نہ خونی رشتہ۔',
  descentAncestor: 'سلسلے میں پیشرو',
  descentDescendant: 'سلسلے میں بعد کی پشت',
  descentRemoves: 'پشتوں کے فاصلے پر',
  kinNotesHeading: 'ریکارڈ شدہ، مگر بے نام',
  kinNoteUnnamed:
    'آرکائیو اس خاندانی رشتے کو درج کرتا ہے مگر دوسری طرف کسی کا نام نہیں لیتا، اس لیے یہاں جوڑنے کے لیے دوسری کوئی شخصیت موجود نہیں۔',
