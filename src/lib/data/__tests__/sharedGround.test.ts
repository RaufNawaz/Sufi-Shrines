...
describe('against the shipped snapshot', () => {
  it('the archive really does hold cross-tradition adjacency', async () => {
     ...
     * asserted-about. Numbers from 20 August 2026: 65 pairs within 800 m, of
     * which several cross traditions — Data Darbar 222 m from Gurdwara Chowmala
     * Sahib, Dargah Pir Ratan Nath 100 m from Gurdwara Bhai Beba Singh.
     *
